...
export const MagicImage = ({ src }) => {
  ...
  return (
    ...
    >
      <img
        src="https://cdn.blog.fisher.medde.rs/img/maplestreetband-6.jpg"
        alt="Magic TV"
        style={{
          display: 'block',
          width: '100%',
...
<div className="hero-container">
  ...
  <div className="text-wrapper">
      ...
      this site is really meant to be a "digital garden" of sorts, and thus should always be considered work in progress. blog posts are marked with status for this reason.
  </div>
</div>
